...
function CardLayout({ href, title, description, tags, lastUpdate, item }) {
  ...
  return (
    ...
    <FlexBox direction="row" alignItems="End" justifyContent="SpaceBetween" style={{padding: "0px 16px 10px 16px", width: "100%"}}>
      <FlexBox
      direction="Row"
      alignItems="Center"
      style={{fontStyle: "italic"}}
      >
        <Text style={{ cursor: "pointer", color: "gray", fontSize: "var(--sapFontSmallSize)", paddingRight: 3 }}>
          {"Last Update:"}
        </Text>
        <Text style={{cursor: "pointer", paddingRight: 3, color: "gray", fontSize: "var(--sapFontSmallSize)"}}>
          {lastUpdate
